...
\begin{equation*}
  P(x=7) =\Sexpr{choose(10,7)} \times \Sexpr{round(0.2^7,6)} \times \Sexpr{round( 0.8^3,6)}
\end{equation*}

\end{small}

\begin{equation*}
  P(x=7) =\Sexpr{round(choose(10,7)*(0.2^7)*(0.8^3),5)}
\end{equation*}
...
\begin{equation*}
  P(x=3) =\Sexpr{choose(5,3)} \times \Sexpr{round(0.5^3,6)} \times \Sexpr{round(0.5^2,6)}
\end{equation*}

\begin{equation*}
  P(x=3) =\Sexpr{round(choose(5,3)*(0.5^3)*(0.5^2),5)}
\end{equation*}
}
...
<<binom freq, size='tiny', fig.height=1.7,fig.width=3,echo=-1>>=
par(mgp=c(1.8,0.5,0), mar=c(3,3,0,1),cex=0.5)
...
<<binom freq2, size='tiny', fig.height=1.7,fig.width=3,echo=-1>>=
par(mgp=c(1.8,0.5,0), mar=c(3,3,0,1),cex=0.5)
...
\begin{center}
$Var[X] = np(1 - p) = 10 \times 0.2 \times (1 - 0.2) = 10 \times 0.2 \times 0.8 = \Sexpr{10*0.2*(1-0.2)}$
\end{center}
...
$Var[X] = \Sexpr{10*0.2*(1-0.2)}$



\column{.7\textwidth}
<<binom plot, size='tiny', fig.height=1.7,fig.width=3,echo=F>>=
par(mgp=c(1.8,0.5,0), mar=c(3,3,0,1),cex=0.5)
hist(x,breaks=7,xlim=c(0,10),main=NA,col="gray70",freq=F)
...
$Var[X] = \Sexpr{10*0.9*(1-0.9)}$

\column{.7\textwidth}

<<binom plot2, size='tiny', fig.height=1.7,fig.width=3,echo=F>>=
set.seed(40)
x2 <- rbinom(1000,size=10,prob=0.9)
par(mgp=c(1.8,0.5,0), mar=c(3,3,0,1),cex=0.5)
hist(x2,breaks=6,xlim=c(0,10),main=NA,col="gray70",freq=F)
